...
import kotlinx.android.synthetic.main.view_profile_value_text.view.*

internal class ProfileValueTextView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.view_profile_value_text, this, true)
    ...
    class Builder {
        ...
        fun build(context: Context): ProfileValueTextView {
            return ProfileValueTextView(context).apply {
                setTitle(title)
                setContent(content)
                setActive(active)
            }
